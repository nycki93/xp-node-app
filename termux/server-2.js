...
server.on('request', async (req, res) => {
    ...
    // this version of nift might be worse than just hand-writing html...
    
    res.write('<!doctype html>\n' + nift([
        'html', { lang: 'en' }, [
            ['meta', { name: 'viewport', content: 'width=device-width' }],
            ['title', 'My Website'],
            ['style', ':root { margin: auto; max-width: 120ch; padding: 2ch; color-scheme: dark; }'],
            ['div', { id: 'main' }, [
                ['h1', 'Hello, World!'],
